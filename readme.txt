...
* Postnord (Posten), DHL Freight, UPS, FedEx Express, DSV, DB Schenker, Schenker
* Pick which shipping services to present for your customers
...
3. Setup the module under 'WooCommerce' / 'Shipping' / 'Fraktalternativ från Fraktjakt'

= Manual Installation =

1. Upload the folder `fraktjakt-woocommerce-shipping` manually to the `/wp-content/plugins/` directory through FTP.
...
4. Basic webshop settings in Fraktjakt
5. Order view in Fraktjakt.
...
Address your questions to [Fraktjakt Support](http://www.fraktjakt.se/om_fraktjakt/kontakt "http://www.fraktjakt.se/om_fraktjakt/kontakt")